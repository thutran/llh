...
void Test_Random_Generator_Singleton(){
    ...
    RandomGeneratorSingleton *rgs = RandomGeneratorSingleton::Get_RandomGeneratorSingleton(111);
    RandomGeneratorSingleton *rgs2 = RandomGeneratorSingleton::Get_RandomGeneratorSingleton();
    ...
    RandomGenerator *rng = new RandomGenerator(111);
